...
[CreateAssetMenu(fileName = "Mob Event Data", menuName = "Game/Event Data/Mob")]
public class MobEventData : EventData
{
    ...
    {
        // Aktivuj toto iba v prípade, že je hráè prítomný.
        if (player)
        {
            // Inak vytvoríme skupinu nepriate¾ov mimo obrazovky a pošleme ich k hráèovi.
