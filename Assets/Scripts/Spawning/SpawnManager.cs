...
public class SpawnManager : MonoBehaviour
{
    ...
    public static Vector3 GeneratePosition()
    {
        ...
        // Náhodne vyberieme, èi "zaokrúhlime" X alebo Y na hranicu (0 alebo 1), aby nepriate¾ vznikol tesne za okrajom obrazovky.
        ...
        // Vynulujeme Z-súradnicu, aby nepriatelia nezostali prilepení na kamere
        spawnPos.z = 0;
